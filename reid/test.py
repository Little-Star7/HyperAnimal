...
parser.add_argument('--test_dir', default='./database/rpdoutdoor', type=str, help='./test_data')
parser.add_argument('--name', default='real_swin', type=str, help='save model path')
parser.add_argument('--batchsize', default=32, type=int, help='batchsize')
parser.add_argument('--linear_num', default=512, type=int, help='feature dimension: 512 or default or 0 (linear=False)')
parser.add_argument('--use_dense', action='store_true', help='use densenet121')
parser.add_argument('--use_efficient', action='store_true', help='use efficient-b4')
parser.add_argument('--use_hr', action='store_true', help='use hr32 net')
...
def get_id(img_path):
    labels = []
    for filename, _ in img_path:
        index = filename.replace('\\', '/').split('/')
...
result = {'gallery_f': gallery_feature.numpy(), 'gallery_label': gallery_label, 'query_f': query_feature.numpy(),
          'query_label': query_label, 'dirs': data_dir}
